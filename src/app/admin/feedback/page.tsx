        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-foreground flex items-center gap-2.5">
              <MessageSquareHeart className="h-7 w-7 text-primary" /> Customer Feedback & CSAT Hub
            </h1>
            <p className="text-sm text-muted-foreground mt-1">
              Real-time user satisfaction, ratings, and feedback insights.
            </p>
          </div>
          <div className="flex items-center gap-2">
            <span className="text-xs font-semibold px-3 py-1.5 rounded-full bg-emerald-500/10 text-emerald-600 border border-emerald-500/20 flex items-center gap-1.5">
              <Sparkles className="h-3.5 w-3.5" /> CSAT Live Analytics
            </span>
          </div>
        </div>
