      ...
      <div className="bg-gradient-to-r from-orange-100/70 via-amber-50/60 to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-800/80 border border-orange-200/80 dark:border-orange-950/40 rounded-2xl p-5 md:p-6 shadow-xs relative overflow-hidden">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0 self-start md:self-center">
            <Button variant="outline" size="sm" onClick={() => fetchJobs(pagination.page)} disabled={isLoading} className="rounded-xl border-orange-200/80 dark:border-slate-800 bg-white/80 dark:bg-slate-900 text-xs font-semibold shadow-2xs hover:bg-orange-50/50">
              <RefreshCw className={cn("h-3.5 w-3.5 mr-1.5 text-orange-600", isLoading && "animate-spin")} />
              Refresh
            </Button>
          </div>
        </div>
