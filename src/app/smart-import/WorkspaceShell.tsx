...
import { Info, Sparkles, Check, FileUp, History, ArrowLeft, X } from "lucide-react";
...
export function WorkspaceShell() {
  ...
  return (
    <div className="space-y-6 pb-20">
      {/* Top Banner — only shown during import workflow, hidden in Live Campaign Dashboard for clean focus */}
      {status !== "EXECUTING" && (
